...
const HowItWorks = () => {
  return (
    <section className="py-20 bg-[#0B0C15]">
          ...
          {steps.map((step, index) => (
            <div key={index} className="relative">
              <div className="bg-gray-900/50 backdrop-blur-xl p-8 rounded-2xl border border-white/10">
                <div className="absolute -top-6 -left-6 w-16 h-16 bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center text-white text-2xl font-bold transform rotate-12">
                  {step.number}
                </div>

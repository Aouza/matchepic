        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center gap-16">
          ...
          <div className="flex-1 flex flex-col justify-center items-start mb-12 md:mb-0">
            <h2 className="text-3xl sm:text-4xl font-bold mb-4 leading-tight">
              <span className="bg-gradient-to-r from-purple-400 via-blue-400 to-purple-400 bg-clip-text text-transparent">Primeiras impressões</span> são visuais.<br />
            ...
            <p className="text-sm text-white/80 mb-6 max-w-md">
              Com <span className="font-semibold text-purple-200">MatchEpic</span>, selfies comuns viram fotos autênticas e irresistíveis.
            </p>
            <a href="#resultados" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-r from-purple-500 to-blue-500 text-white font-medium hover:opacity-90 transition-all duration-200 shadow-lg text-sm">
          ...
          <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-5 w-full max-w-lg">
            ...
            <div className="bg-[#10111A] rounded-2xl border border-white/10 p-5 flex flex-col items-start gap-2">
              ...
              <h4 className="text-base font-semibold text-white">Mais Matches</h4>
              <p className="text-xs text-white/70">Boas fotos geram até 3x mais interações.</p>
            </div>
            {/* Card 2 */}
            <div className="bg-[#10111A] rounded-2xl border border-white/10 p-5 flex flex-col items-start gap-2">
              <div className="w-9 h-9 flex items-center justify-center rounded-full bg-blue-500/10 mb-1">
                <svg className="w-5 h-5 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 1.343-3 3s1.343 3 3 3 3-1.343 3-3-1.343-3-3-3zm0 0V4m0 10v4m8-8h-4m-4 0H4" /></svg>
              </div>
              <h4 className="text-base font-semibold text-white">Confiança</h4>
              <p className="text-xs text-white/70">Transmita credibilidade e segurança.</p>
            </div>
            {/* Card 3 */}
            <div className="bg-[#10111A] rounded-2xl border border-white/10 p-5 flex flex-col items-start gap-2">
              ...
              <p className="text-xs text-white/70">Fotos de qualidade aumentam o interesse.</p>
            </div>
            {/* Card 4 */}
            <div className="bg-[#10111A] rounded-2xl border border-white/10 p-6 flex flex-col items-start gap-3">
              <div className="w-10 h-10 flex items-center justify-center rounded-full bg-pink-500/10 mb-2">
                <svg className="w-6 h-6 text-pink-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 20l9-5-9-5-9 5 9 5zm0 0v-8" /></svg>
              </div>
              <h4 className="text-lg font-semibold text-white">Naturalidade</h4>
              <p className="text-sm text-white/70">Fotos naturais e espontâneas geram mais conexão e interesse.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="relative py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl sm:text-4xl font-bold mb-8 leading-tight">
            ...
            <span className="bg-gradient-to-r from-blue-400 via-blue-500 to-purple-500 bg-clip-text text-transparent">vale mais do que você imagina</span>
          </h2>
